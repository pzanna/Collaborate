...
db_manager: Optional[HierarchicalDatabaseManager] = None
...
async def lifespan(app: FastAPI):
    ...
    global config_manager, db_manager, ai_manager, research_manager, context_manager, mcp_client
...
app.include_router(
    v2_academic_router, prefix="/api/v2", tags=["v2-academic-search"]
)
    ...
    try:
        ...
        if mcp_client:
            try:
                ...
                mcp_status = {"status": "error", "connected": False, "error": str(e)}
        else:
