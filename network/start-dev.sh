...
# network Service Development Startup Script
# This script starts the network service with file watching for development

set -e

echo "🚀 Starting network Service in development mode..."
...
export SERVICE_NAME="${SERVICE_NAME:-network}"
...
echo "🔍 Starting network service with file watching..."
