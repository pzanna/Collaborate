...
# network Service Production Startup Script
# This script starts the network service in production mode

set -e

echo "🚀 Starting network Service in production mode..."
...
# Start the service
exec python3 -m src.network_service
