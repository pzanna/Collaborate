...
from ai_clients.openai_client import OpenAIClient, AIProviderConfig
...
class PRISMAValidator:
    ...
    def validate_prisma_structure(data: Dict[str, Any]) -> bool:
        ...
        required_sections = [
            "metadata", "results", "data_extraction_tables"
        ]
...
class ThesisLiteratureReviewGenerator:
    ...
    def _call_ai_model(self, prompt: str, system_prompt: Optional[str] = None, schema: Optional[Dict] = None) -> str:
        ...
        try:
            ...
            # Cache response
            if self.cache:
                self.cache.set(prompt, self.config.ai_model, 
                             self.config.temperature, self.config.top_p, response)
            ...
            "properties": {
                "themes": {
                    ...
                    "items": {
                        ...
                        "required": ["name", "summary", "representative_studies", "strength_of_evidence", "study_count"]
                    },
                    "minItems": 3,
                    "maxItems": 7
                }
            ...
            "properties": {
                "gaps": {
                    ...
                    "items": {
                        ...
                        "required": ["title", "description", "justification", "impact_score", 
                                   "feasibility_score", "novelty_score", "related_themes"]
                    },
                    "minItems": 3,
                    "maxItems": 6
                }
    ...
    def generate_research_questions(self, gaps: List[ResearchGap], conceptual_model: ConceptualModel) -> List[ResearchQuestion]:
                ...
                "research_questions": {
                    ...
                    "items": {
                        ...
                        "properties": {
                            ...
                            "predicted_direction": {"type": "string", "enum": ["positive", "negative", "moderated", None]},
...
def main():
    ...
    parser.add_argument("--input", "-i", required=True,
                       help="Input PRISMA JSON file")
    parser.add_argument("--output", "-o", default="output",
                       help="Output directory")
    parser.add_argument("--templates", "-t", default="templates",
                       help="Template directory")
    parser.add_argument("--cache", "-c", default="cache",
