...
class SelectionBiasDetector:
    ...
    async def detect_selection_bias(self, search_strategy: Dict[str, Any], studies: List[Dict[str, Any]]) -> List[BiasTest]:
        """
    ...
    async def _assess_date_restriction_bias(self, search_strategy: Dict[str, Any], studies: List[Dict[str, Any]]) -> BiasTest:
