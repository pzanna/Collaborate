...
class AccessControlManager:
    ...
    def _init_database(self):
        ...
        try:
            with sqlite3.connect(self.db_path) as conn:
                ...
                cursor.execute("CREATE INDEX IF NOT EXISTS idx_project_access_user_project ON project_access(user_id, project_id)")
    ...
    async def create_user(self, username: str, email: str, full_name: str, 
                         password: str, role: UserRole = UserRole.REVIEWER) -> User:
        """
    ...
    async def authenticate_user(self, username: str, password: str, 
                              ip_address: str, user_agent: str) -> Tuple[Optional[User], Optional[Session]]:
        """
    ...
    async def validate_session(self, session_id: str, ip_address: Optional[str] = None) -> Optional[Tuple[User, Session]]:
        """
    ...
    async def check_permission(self, user_id: str, permission: Permission, 
                             project_id: Optional[str] = None, resource_id: Optional[str] = None) -> bool:
        """
    ...
    async def grant_project_access(self, user_id: str, project_id: str, role: UserRole, 
                                 granted_by: str, expires_date: Optional[datetime] = None) -> ProjectAccess:
        """
    ...
    async def log_user_action(self, user_id: str, session_id: str, action: ActionType,
                            resource_type: ResourceType, resource_id: str,
                            project_id: Optional[str] = None, ip_address: str = "127.0.0.1",
                            user_agent: str = "unknown", details: Optional[Dict[str, Any]] = None,
    ...
    async def get_audit_logs(self, user_id: Optional[str] = None, project_id: Optional[str] = None,
        ...
        try:
            with sqlite3.connect(self.db_path) as conn:
                ...
                """, (
                    ...
                    user.password_hash, user.salt, user.role.value, user.is_active,
        ...
        try:
            ...
            with sqlite3.connect(self.db_path) as conn:
                ...
                """, (
                    ...
                    session.is_active, session.expires_at.isoformat()
                ))
                conn.commit()
        ...
        try:
            with sqlite3.connect(self.db_path) as conn:
                ...
                cursor.execute("""
                    ...
                    VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)
                """, (
                    project_access.access_id, project_access.user_id,
                    project_access.project_id, project_access.role.value,
    ...
    async def _log_action(self, user_id: str, session_id: str, action: ActionType,
                         resource_type: ResourceType, resource_id: str,
                         ip_address: str, user_agent: str, details: Dict[str, Any],
                         success: bool, project_id: Optional[str] = None, error_message: Optional[str] = None):
        ...
        try:
            ...
            with sqlite3.connect(self.db_path) as conn:
                ...
                cursor.execute("""
                    ...
                    VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
                """, (
                    log_entry.log_id, log_entry.user_id, log_entry.session_id,
                    log_entry.action.value, log_entry.resource_type.value,
                    log_entry.resource_id, log_entry.project_id,
                    log_entry.timestamp.isoformat(), log_entry.ip_address,
                    log_entry.user_agent, json.dumps(log_entry.details),
                    log_entry.success, log_entry.error_message
                ))
                conn.commit()
