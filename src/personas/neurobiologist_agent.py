...
- Flowcharts for decision logic (e.g., contamination response, media optimisation)"""
    ...
    async def _initialize_agent(self) -> None:
        ...
        try:
            ...
            self.logger.info(f"Neurobiologist persona agent initialized with {len(self.expertise_areas)} expertise areas")
    ...
    async def process_action(self, action: ResearchAction) -> AgentResponse:
        ...
        try:
            ...
            if action.action not in ["expert_consultation", "protocol_design", 
                                   "data_interpretation", "experimental_guidance"]:
    ...
    async def _generate_expert_response(self, query: str, context: Dict[str, Any], 
                                      expertise_area: str) -> str:
        """
    ...
    def _prepare_enhanced_prompt(self, query: str, context: Dict[str, Any], 
                               expertise_area: str) -> str:
