...
class PersonaMCPIntegration:
    ...
    async def request_expert_consultation(self, 
                                        expertise_area: str,
                                        query: str,
                                        context: Optional[Dict[str, Any]] = None,
                                        preferred_persona: Optional[str] = None) -> AgentResponse:
        """
    ...
    async def get_consultation_history(self, limit: int = 10) -> Dict[str, Any]:
        ...
        try:
            ...
            completed_consultations = sum(
                1 for c in self.consultation_history.values() 
    ...
    def _create_consultation_error_response(self, action: ResearchAction, 
                                          persona_type: PersonaType) -> AgentResponse:
