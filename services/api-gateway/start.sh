...
# api-gateway Service Production Startup Script
# This script starts the api-gateway service in production mode

set -e

echo "🚀 Starting api-gateway Service in production mode..."
