...
# mcp-server Service Development Startup Script
# This script starts the mcp-server service with file watching for development

set -e

echo "🚀 Starting mcp-server Service in development mode..."
...
export SERVICE_NAME="${SERVICE_NAME:-mcp-server}"
export SERVICE_HOST="${SERVICE_HOST:-0.0.0.0}"
export SERVICE_PORT="${SERVICE_PORT:-9000}"
...
echo "🔍 Starting mcp-server service with file watching..."
