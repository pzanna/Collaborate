...
# mcp-server Service Production Startup Script
# This script starts the mcp-server service in production mode

set -e

echo "🚀 Starting mcp-server Service in production mode..."
