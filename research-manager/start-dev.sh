...
# research-manager Service Development Startup Script
# This script starts the research-manager service with file watching for development

set -e

echo "🚀 Starting research-manager Service in development mode..."
