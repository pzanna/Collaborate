...
class AIIntegration:
    ...
    async def review_literature_results(self, plan, search_results) -> List[Dict[str, Any]]:
            ...
            prompt = (
                ...
                # "2. A **literature synthesis** that:\n"
                # "- Groups papers by thematic area or research question\n"
                # "- Summarises key findings and their contributions\n"
                # "- Shows how they collectively support the research plan\n"
                # "3. A **gap analysis**, highlighting:\n"
                # "- Any remaining weaknesses or unexplored areas\n"
                # "- Potential risks or assumptions\n"
                # "- Suggestions for how to address remaining gaps (e.g., additional searches, experimental data, meta-analysis)\n\n"
