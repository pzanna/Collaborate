...
# Planning Agent Service Development Startup Script
# This script starts the containerized Planning Agent with file watching for development

set -e

echo "Starting Planning Agent Service in Development Mode..."
...
# Start the Planning Agent service with file watching
echo "Starting Planning Agent Service with file watching..."
exec watchfiles --filter python 'python -m src.planning_service' /app/src
