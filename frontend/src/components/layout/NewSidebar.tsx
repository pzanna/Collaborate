...
const Sidebar: React.FC = () => {
  ...
  const navigationItems = [
    { id: "chat", label: "Chat", icon: ChatBubbleLeftIcon, path: "/chat" },
      ...
      <div className="flex flex-col h-full">
        <div className="p-4 border-b border-gray-200">
          <button
            ...
            className="w-full p-2 text-gray-500 hover:text-gray-700 hover:bg-gray-100 rounded-md"
          >
      ...
      <div className="p-4 border-b border-gray-200">
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-sm text-gray-500">Multi-AI Platform</p>
          </div>
          <button
            onClick={() => dispatch(toggleSidebar())}
